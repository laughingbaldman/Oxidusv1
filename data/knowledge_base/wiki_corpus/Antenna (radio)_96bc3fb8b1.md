...
domain: "engineering"
source_id: "wikipedia"
source_url: "https://en.wikipedia.org/wiki/Antenna_(radio)"
source_title: "Antenna (radio)"
source_type: "wiki"
topic_type: "wiki_article"
license: "CC BY-SA 4.0"
curator: "oxidus_wiki_crawler"
created_utc: "2026-02-09T13:31:31.873396"
updated_utc: "2026-02-09T20:31:31Z"
lifecycle_state: "raw"
content_length: 67134
links_count: 585
...
Sometimes the resulting (lower) electrical resonant frequency of such a system (antenna plus matching network) is described using the concept of electrical length. An antenna operated at a lower frequency than its self‑resonant frequency is then called an 
...
The loss resistance will generally affect the feedpoint impedance, adding to its resistive component. That resistance will consist of the sum of the radiation resistance Rrad and the loss resistance Rloss. If a current I is delivered to the terminals of an antenna, then a power of I2 Rrad will be radiated and a power of I2 Rloss will be lost as heat. Therefore, the efficiency of an antenna is equal to ⁠Rrad/(Rrad + Rloss)⁠. Only the total resistance Rrad + Rloss can be directly measured.
